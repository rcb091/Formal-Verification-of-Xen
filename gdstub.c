VCC uses function specifications in a different way. While going through the body of a function, VCC assumes that each precondition of the function is satisfied on function entry itself. Also, VCC adds each postcondition of the function as assertions before the function returns. Whenever there is a function call, VCC replaces it with assertions of the preconditions and postconditions. For instance, VCC translates the program above generally as follows:
